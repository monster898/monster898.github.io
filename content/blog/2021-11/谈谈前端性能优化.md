...
![](./images/Snipaste_2021-11-07_17-59-29.png)
...
![](./images/Snipaste_2021-11-07_18-02-39.png)
...
于是我们使用 `requestAnimationFrame()` 来解决这个问题，它的原理是在每一次重绘前执行相应的 js 代码，来达到下图的理想状态：
