...
![](./images/Snipaste_2022-03-05_15-22-37.png)

因为 IE 浏览器并不支持`AbortController API`,`axios`使用了[abortcontroller-polyfill](https://github.com/mo/abortcontroller-polyfill)这个库来提供支持。
